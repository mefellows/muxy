// Adapted from the fine folks at Docker: https://github.com/docker/machine/blob/382f71fdda6f689d4de465588e4a76e9b8ae2836/utils/certs.go
...
func GenerateCACertificate(certFile, keyFile, org string, bits int) error {
	...
	template.IsCA = true
	template.Subject.CommonName = "Pki CA Root"
